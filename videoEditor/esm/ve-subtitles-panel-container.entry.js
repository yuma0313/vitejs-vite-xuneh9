import { r as registerInstance, h } from './index-f9f850bb.js';
import { A as ApplicationStore, I as It, K as Kt } from './ApplicationStore-824bdfff.js';
import { P as PlusIcon } from './PlusIcon-e5b6b201.js';
import { R as RendleyService } from './RendleyService-23f7521e.js';
import { E as Engine, e as ClipTypeEnum, R as RendleyStore } from './RendleyStore-b5f665fd.js';
...
const SubtitlesPanelContainer = class {
    ...
    componentWillLoad() {
        ...
        this.disposeReaction = Kt(() => RendleyStore.currentTime, (currentTime) => {
            let activeIndex = -1;
            if (this.subtitles == null) {
                return;
            }
...
export { SubtitlesPanelContainer as ve_subtitles_panel_container };
