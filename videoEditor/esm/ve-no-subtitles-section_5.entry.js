import { h, r as registerInstance } from './index-f9f850bb.js';
import { t } from './translation-e53f3050.js';
import { s as secondsToTimecode, T as TrashIcon } from './TrashIcon-aa84919a.js';
import { c as clsx } from './clsx-1afe6a70.js';
import { R as RendleyStore, E as Engine, H as HighlightAnimationEnum } from './RendleyStore-b5f665fd.js';
import { I as It, A as ApplicationStore } from './ApplicationStore-824bdfff.js';

const SubtitlesIcon = () => {
    return (h("svg", { width: "25", height: "25", viewBox: "0 0 25 25", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        h("path", { d: "M7.5 13.5H11.5", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M15.5 13.5H17.5", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M7.5 9.5H9.5", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M13.5 9.5H17.5", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M21.5 15.5C21.5 16.0304 21.2893 16.5391 20.9142 16.9142C20.5391 17.2893 20.0304 17.5 19.5 17.5H7.5L3.5 21.5V5.5C3.5 4.96957 3.71071 4.46086 4.08579 4.08579C4.46086 3.71071 4.96957 3.5 5.5 3.5H19.5C20.0304 3.5 20.5391 3.71071 20.9142 4.08579C21.2893 4.46086 21.5 4.96957 21.5 5.5V15.5Z", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};

const ImportSrtIcon = () => {
    return (h("svg", { width: "25", height: "25", viewBox: "0 0 25 25", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        h("path", { d: "M20.5 4.5H4.5C3.39543 4.5 2.5 5.39543 2.5 6.5V18.5C2.5 19.6046 3.39543 20.5 4.5 20.5H20.5C21.6046 20.5 22.5 19.6046 22.5 18.5V6.5C22.5 5.39543 21.6046 4.5 20.5 4.5Z", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M10.5 8.5H10.501", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M14.5 8.5H14.501", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M8.5 12.5H8.501", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M12.5 12.5H12.501", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        h("path", { d: "M7.5 16.5H17.5", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};
...
export { NoSubtitlesSection as ve_no_subtitles_section, SubtitleRow as ve_subtitle_row, SubtitleRowDivider as ve_subtitle_row_divider, SubtitlesStylesContainer as ve_subtitles_styles_container, Tabs as ve_tabs };
